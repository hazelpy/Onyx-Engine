...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		kadeEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " - " + CoolUtil.difficultyFromInt(storyDifficulty) + (Main.watermarks ? " | KE " + MainMenuState.engineVer : ""), 16);
