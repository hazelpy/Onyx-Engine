...
class OptionsMenu extends MusicBeatState
{
	...
	var developerCategory:OptionCategory = new OptionCategory("Developer", [
		new AllowReturnToTitleOption("Allow users to go back to the title screen from the main menu.")
	]);
	...
	override function update(elapsed:Float)
	{
		...
		if (acceptInput)
		{
			...
			if (FlxG.keys.pressed.RBRACKET) {
				currentSelectedCat = developerCategory;
				isCat = true;
				grpControls.clear();
				for (i in 0...currentSelectedCat.getOptions().length)
					{
