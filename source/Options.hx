...
class AllowReturnToTitleOption extends Option
{
	public function new(desc:String)
	{
		super();
		description = desc;
		if (FlxG.save.data.titleReturn == null) FlxG.save.data.titleReturn = true;
	}

	public override function press():Bool
	{
		FlxG.save.data.titleReturn = !FlxG.save.data.titleReturn;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "Title Return " + (!FlxG.save.data.titleReturn ? "Off" : "On");
	}
}